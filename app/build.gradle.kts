...
android {
    namespace = "dev.masalimov.nutritiontracker"
    compileSdk = 36

    defaultConfig {
        applicationId = "dev.masalimov.nutritiontracker"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"

        testInstrumentationRunner = "dev.masalimov.nutritiontracker.HiltTestRunner"
    }
